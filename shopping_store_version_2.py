...
menu = input("What action would you like todo, type 1 for shopping, type 2 for a balance check or type 3 for exit? ")
if menu == '1':
...
if menu == '2':
        customer_budget = int(input("Please input your budget for today's shopping? "))
