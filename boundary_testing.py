...
print("Hello {}, welcome to Henderson High School's Production.")
...
child_tickets = float(input("Please insert how many Adult (aged between 19 and 59) tickets you would like to buy?"))
adult_tickets = float(input("Please insert how many Senior (anyone aged aboved 60 tickets you would like to buy?"))
...
print("Your total is {}".format(grand_total))
